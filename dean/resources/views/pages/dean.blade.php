...
<div class="container">
    <div class="row border shadow-sm p-3 mb-5 bg-white rounded">
        <div class="col-12">
            <img
                src="https://sun9-67.userapi.com/impg/8WG9_KGZoN2zs6V0e7AAbqNt4zdXCkWHkdCuXw/GOxclVezzXg.jpg?size=100x100&quality=96&proxy=1&sign=1297e835a75bc6099f7d645cc6b0e555&type=album"
                alt="deanAvatar" class="img-thumbnail">
            <p class="text-xl-left">Dean personal</p>
        </div>
        ...
        <div class="col-6 float-right border shadow p-3 mb-5 bg-white rounded">
            <p class="text-xl-left">Справки</p>
            <br>
            <div class="container">
                    ...
                    @foreach($fios as $fio)
                        @if($fio->annex_type != 'заявления')
                            ...
                            <div class="row row-cols-2 p-1 border rounded">
                                ...
                                <div class="col"><p class="text-xl-left my-auto"></p>
                                    {{--                            @foreach($fra as $text)--}}
                                ...
                                <div class="col  my-auto">
                                    ...
                                    <div class="modal fade" id="annex" tabindex="-1" role="dialog"
                                         aria-labelledby="myModalLabel"
                                         aria-hidden="true">
                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel">Ответить справшику</h4>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <form action="{{url('/annexDean')}}" method="POST" id="send-form">
                                                    @csrf

                                                    {{--                                                <p class="text-xl-left">{{serialize($types)}}</p>--}}
                                                    @foreach($types as $type)
                                                        {{--                                                <strong><p class="text-xl-left">{{serialize($type)}}</p></strong>--}}
                                                        @foreach($type as $typ)
                                                            {{--                                                        <p class="text-xl-left">{{serialize($typ)}}</p>--}}
                                                            <strong><p class="text-xl-left">{{$typ->annex_type}}</p>
                                                            </strong>
                                                        @endforeach
                                                    @endforeach
                                                    @foreach($info as $inf)
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="exampleFormControlTextarea1">Area для
                                                                ответа</label>
                                                            <textarea class="form-control" name="text_zayavDean"
                                                        ...
                                                        <div class="form-group mx-sm-3 mb-2">
                                                            ...
                                                            <input type="text" class="form-control" name="numCode"
                                                                   id="inputPassword2" placeholder="KEY num for annex">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="zayav" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{url('/zayavDean')}}" method="POST" id="send-form">
                                                    @csrf
                                                    <div class="modal-body">
                                                        {{--                                                @if(count($zayav) >0)--}}
                                                        {{--                                                    @foreach($zayav as $text)--}}
                                                        {{--                                                        <p class="text-xl-left">{{$text}}</p>--}}
                                                        {{--                                                    @endforeach--}}
                                                        ...
                                                        <div class="form-group">
                                                            <label for="exampleFormControlTextarea1">Area для
                                                                ответа</label>
                                                            <textarea class="form-control" name="text_zayav"
                                                                      id="exampleFormControlTextarea1"
                                                                      rows="3"></textarea>
                                                        </div>
                                                        <div class="form-group mx-sm-3 mb-2">
                                                            <label for="inputPassword2" class="sr-only">Password</label>
                                                            <input type="text" class="form-control" name="numCode"
                                                                   id="inputPassword2" placeholder="KEY num">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit"
